...
public class EditUser extends Webutils{
	Logger log = Logger.getLogger(EditUser.class);
	...
	private By input_Phone=By.xpath("//input[@id='phoneNumber']");
	...
	private By input_TimeAccess=By.xpath("//input[@id='timeacces']");
